...
TEST(MergeTrajectoryGaussian, SameSize) {
    constexpr int W = 5;
    models::Mixture<models::Trajectory<models::Gaussian<>, W>> mix;
    Eigen::VectorXd m1(4), m2(4);
    m1 << 0.0, 0.0, 1.0, 0.0;
    m2 << 0.1, 0.1, 1.0, 0.0;
    Eigen::MatrixXd cov = Eigen::MatrixXd::Identity(4, 4);

    mix.add_component(std::make_unique<models::Trajectory<models::Gaussian<>, W>>(4, models::Gaussian<>(m1, cov)), 0.5);
    mix.add_component(std::make_unique<models::Trajectory<models::Gaussian<>, W>>(4, models::Gaussian<>(m2, cov)), 0.3);
...
TEST(MergeTrajectoryGGIW, SameSize) {
    constexpr int W = 5;
    models::Mixture<models::Trajectory<models::GGIW<>, W>> mix;
    Eigen::VectorXd m1(4), m2(4);
    m1 << 0.0, 0.0, 1.0, 0.0;
    m2 << 0.1, 0.1, 1.0, 0.0;
    Eigen::MatrixXd cov = Eigen::MatrixXd::Identity(4, 4);
    ...
    mix.add_component(std::make_unique<models::Trajectory<models::GGIW<>, W>>(4, models::GGIW<>(10.0, 5.0, m1, cov, 10.0, V)), 0.5);
    mix.add_component(std::make_unique<models::Trajectory<models::GGIW<>, W>>(4, models::GGIW<>(12.0, 6.0, m2, cov, 11.0, V)), 0.3);
