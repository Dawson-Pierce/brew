...
TEST(PHDTracking, TwoPointTargets) {
    ...
    test::print_tracking_header("Gaussian PHD Tracking - Two Point Targets");
...
#ifdef BREW_ENABLE_PLOTTING
    {
        ...
        brew::plot_utils::save_figure(fig,
            "/workspace/brew/output/phd_gaussian_two_targets.png");
    }
#endif
}
...
TEST(PHDTracking, ExtendedTargetGGIW) {
    ...
    test::print_tracking_header("GGIW PHD Tracking - Single Extended Target");
    std::cout << std::setw(5) << "Step"
              << std::setw(10) << "N_meas"
              << std::setw(10) << "N_comp"
              << std::setw(10) << "N_est"
...
#ifdef BREW_ENABLE_PLOTTING
    {
        ...
        ax->ylabel("y");
        brew::plot_utils::save_figure(fig,
            "/workspace/brew/output/phd_ggiw_extended_target.png");
    }
#endif
}
