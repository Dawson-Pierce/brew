...
// MBM multi-object filter for the `ggiw_orientation` package. Devirtualized: holds the
...
using MBM = brew::multi_target::MBM<models::GGIWOrientation<Scalar, D, De>, MaxComponents>;
