...
// JGLMB multi-object filter for the `ggiw_orientation` package. Devirtualized: holds the
...
using JGLMB = brew::multi_target::JGLMB<models::GGIWOrientation<Scalar, D, De>, MaxComponents>;
