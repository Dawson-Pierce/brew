...
// CPHD multi-object filter for the `ggiw_orientation` package. Devirtualized: holds the
...
using CPHD = brew::multi_target::CPHD<models::GGIWOrientation<Scalar, D, De>, MaxComponents>;
