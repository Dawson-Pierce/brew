...
// CPHD multi-object filter for the `trajectory_ggiw_orientation` package. Devirtualized: holds the
...
using CPHD = brew::multi_target::CPHD<models::TrajectoryGGIWOrientation<MaxWindow, Scalar, D, De>, MaxComponents>;
