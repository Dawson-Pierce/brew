...
// PHD multi-object filter for the `trajectory_ggiw_orientation` package. Devirtualized: holds the
...
using PHD = brew::multi_target::PHD<models::TrajectoryGGIWOrientation<MaxWindow, Scalar, D, De>, MaxComponents>;
