...
// PMBM multi-object filter for the `trajectory_ggiw_orientation` package. Devirtualized: holds the
...
using PMBM = brew::multi_target::PMBM<models::TrajectoryGGIWOrientation<MaxWindow, Scalar, D, De>, MaxComponents>;
