...
// CPHD multi-object filter for the `trajectory_iggiw` package. Devirtualized: holds the
...
using CPHD = brew::multi_target::CPHD<models::TrajectoryIGGIW<MaxWindow, Scalar, D, De>, MaxComponents>;
