...
// MBM multi-object filter for the `trajectory_iggiw` package. Devirtualized: holds the
...
using MBM = brew::multi_target::MBM<models::TrajectoryIGGIW<MaxWindow, Scalar, D, De>, MaxComponents>;
