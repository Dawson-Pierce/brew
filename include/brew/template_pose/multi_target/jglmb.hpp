...
// JGLMB multi-object filter for the `template_pose` package. Devirtualized: holds the
...
using JGLMB = brew::multi_target::JGLMB<models::TemplatePose<Scalar, D>, MaxComponents>;
