...
// GLMB multi-object filter for the `template_pose` package. Devirtualized: holds the
...
using GLMB = brew::multi_target::GLMB<models::TemplatePose<Scalar, D>, MaxComponents>;
