...
// PHD multi-object filter for the `template_pose` package. Devirtualized: holds the
...
using PHD = brew::multi_target::PHD<models::TemplatePose<Scalar, D>, MaxComponents>;
