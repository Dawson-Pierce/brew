...
// MBM multi-object filter for the `trajectory_ggiw` package. Devirtualized: holds the
...
using MBM = brew::multi_target::MBM<models::TrajectoryGGIW<MaxWindow, Scalar, D, De>, MaxComponents>;
