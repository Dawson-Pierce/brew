...
// PMBM multi-object filter for the `trajectory_ggiw` package. Devirtualized: holds the
...
using PMBM = brew::multi_target::PMBM<models::TrajectoryGGIW<MaxWindow, Scalar, D, De>, MaxComponents>;
