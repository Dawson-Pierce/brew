...
// PHD multi-object filter for the `trajectory_gaussian` package. Devirtualized: holds the
...
using PHD = brew::multi_target::PHD<models::TrajectoryGaussian<MaxWindow, Scalar, D>, MaxComponents>;
